...
import com.example.mobilecomputingfinalproject.IngredientAdder;
import com.example.mobilecomputingfinalproject.R;
import com.example.mobilecomputingfinalproject.Recipe;
import com.example.mobilecomputingfinalproject.RecipeAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void openIngView() {
        Intent intent = new Intent(MainActivity.this, IngredientAdder.class);
    ...
    private void addRecipe() {
        ...
        if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(description)) {
            ...
            StorageReference titleAndDescriptionRef = storageRef.child(tempTitle);
